...
const CompleteTask = ({data}) => {
  return (
    <div  className='flex-shrink-0 w-90 h-full bg-blue-400 rounded-2xl'>
            <div className='flex justify-between p-5'>
                ...
                <h3 className='bg-cyan-950 h-1/3 px-3 py-1 rounded-lg'>{data.category}</h3>
            ...
            <div className='mt-2 p-2' >
                <button className='w-full flex items-end justify-center  bg-green-600 hover:bg-green-800 rounded-md '>Completed</button>
            </div>
        </div>
  )
}
